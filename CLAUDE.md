...
8. **При тестировании сначала проверяй localhost:3000** Скорее всего сервер уже запущен, а проверить его работу проще, чем каждый раз пытаться запускать сервер и получать ошибку
