...
Каталог предметов из маркета хранится как статические TS-данные (`packages/db/src/seed/item-templates-defaults.ts`, 112 шаблонов) — внешний файл не нужен, сид самодостаточен.
...
make seed-demo   # досеять демо-данные (dev-пользователи)
