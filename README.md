...
Каталог предметов из маркета хранится как статические TS-данные (`packages/db/src/seed/Gob_markets.ts`, 112 шаблонов) — внешний файл не нужен, сид самодостаточен.
